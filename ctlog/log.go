	...
	for i := range resp.Entries {
		...
		if e.Precert != nil && e.Precert.TBSCertificate != nil {
			...
			for ii := range e.Precert.TBSCertificate.ExcludedDNSDomains {
				if dns.IsValid(e.Precert.TBSCertificate.ExcludedDNSDomains[ii]) {
